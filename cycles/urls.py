...
urlpatterns = [
    ...
    path('addRecurringFormDetail/<int:cycle_id>', views.addRecurringFormDetail, name='addRecurringFormDetail'),
    path('addRecurringDetail/<int:cycle_id>', views.addRecurringDetail, name='addRecurringDetail'),
